                    ...
                    <form role="form" method="POST" action={{ route('user.store') }} enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-select">
                                            <option class="not-select" value="" disabled selected>
                                                -- Quyền --</option>
                                            <option value="Quản trị viên" @if (old('role') == 'Quản trị viên') selected @endif>
                                                Quản trị viên</option>
                                            <option value="Giáo viên" @if (old('role') == 'Giáo viên') selected @endif>
                                                Giáo viên</option>
                                            <option value="Học sinh" @if (old('role') == 'Học sinh') selected @endif>
                                                Học sinh</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="password" class="form-control-label">Niên khóa</label>
                                        <input class="form-control" type="password" id="password_confirmation"
                                            name="password_confirmation" placeholder="Nếu là học sinh thì điền niên khóa">
                                    </div>
                                </div>
                            </div>
                            <hr class="horizontal dark">
