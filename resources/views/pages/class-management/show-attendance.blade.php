                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($class->students as $student)
                                                <tr>
                                                    ...
                                                    @foreach ($lessons as $lesson)
                                                        @if (App\Models\Attendance::where('lesson_id', $lesson->id)->where('student_id', $student->id)->where('status', 0)->first() != null)
                                                            <td>
                                                                <i class="fa-solid fa-circle-check" style="color:green"></i>
                                                            </td>
                                                        @elseif (App\Models\Attendance::where('lesson_id', $lesson->id)->where('student_id', $student->id)->where('status', 1)->first() != null)
                                                            <td>
