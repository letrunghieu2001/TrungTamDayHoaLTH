                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">Tạo lớp học mới - Bước 2: Thêm giáo viên dạy</p>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <form role="form" method="POST" action={{ route('class.store-step-two') }}
                                        ...
                                        <div class="card-body px-0 pt-0 pb-2">
                                            <div class="table-responsive p-0">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-sm ms-auto"
                                                    style="margin: 20px 0; float: right">Tạo lớp học</button>
                                            </div>
                                        </div>
                                </div>
                            </div>
