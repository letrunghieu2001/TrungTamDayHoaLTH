...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Tạo bài đăng'])
    <style>
        .custom-profile-pic {
            color: transparent;
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form role="form" method="POST" action={{ route('myblog.store') }} enctype="multipart/form-data">
                        @csrf
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Tạo bài đăng mới</p>
                                <button type="submit" class="btn btn-primary btn-sm ms-auto">Tạo bài đăng</button>
                            </div>
                        </div>
                        <div class="card-body">
