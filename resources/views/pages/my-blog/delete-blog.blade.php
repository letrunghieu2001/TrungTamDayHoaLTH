        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div>
                        <a href="{{ URL::signedRoute('myblog.active') }}" style="color: blue; font-size: 15px"><i
                                class="fa-solid fa-arrow-left-long"></i> Trang trước</a>
                    </div>
                    <div class="d-flex bd-highlight mb-3">
                        <h6 class="me-auto p-2 bd-highlight">Danh sách bài viết bị ẩn</h6>
                        @if (count($blogs) > 0)
                            <form action="{{ route('myblog.restore-all') }}" method="POST">
                                @csrf
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content" style="width:150%">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('myblog.force-delete', [$blog->id]) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                                                ...
                                                                <div class="modal-content" style="width:150%">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                                                                            data-bs-dismiss="modal">Đóng</button>
                                                                        <form
                                                                            action="{{ route('myblog.restore', [$blog->id]) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            <button type="submit"
