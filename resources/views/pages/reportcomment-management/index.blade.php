                                        ...
                                        @foreach ($reportComments as $reportComment)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <span class="text-secondary overflow text-xs font-weight-bold">Tài
                                                            khoản đã bị xóa</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0 reason">{!! optional($reportComment->comment)->content !!}
                                                    </p>
                                                </td>
                                                <td>
                                                ...
                                                <td class="align-middle">
                                                    <a style="cursor: pointer" data-bs-toggle="modal"
                                                        data-bs-target="#deleteCommentModal-{{ $reportComment->reportcomment_id }}"
                                                        class="tt-icon-btn"><i class="fa-solid fa-trash"></i></a>
                                                    <a style="cursor: pointer" data-bs-toggle="modal"
                                                        data-bs-target="#deletereportCommentModal-{{ $reportComment->reportcomment_id }}"
                                                        class="tt-icon-btn"><i class="fa-solid fa-ban"></i></a>
                                                    <a
                                                        href="{{ route('blog.show', [$reportComment->post_id]) }}"><i
                                                            class="fa-solid fa-arrow-up-right-from-square"></i></a>
                                                    <div class="modal fade"
                                                        id="deleteCommentModal-{{ $reportComment->reportcomment_id }}" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content" style="width:150%">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('report-comment.delete', [$reportComment->reportcomment_id]) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
                                                    ...
                                                    <div class="modal fade"
                                                        id="deletereportCommentModal-{{ $reportComment->reportcomment_id }}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content" style="width:150%">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Bạn có chắc muốn xóa báo cáo bình luận này không ?
                                                                    </p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary"
                                                                        data-bs-dismiss="modal">Đóng</button>
                                                                    <form
                                                                        action="{{ route('report-comment.delete-report', [$reportComment->reportcomment_id]) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
