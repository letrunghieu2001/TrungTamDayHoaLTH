            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex bd-highlight mb-3">
                        <h6 class="me-auto p-2 bd-highlight">Quản lý blogs</h6>
                        <a href="{{ route('blog.delete-blog') }}"><button class="btn btn-primary btn-sm ms-auto button-float"
                    ...
                    <div class="table-responsive p-0">
                        <nav>
                            <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                                <a href="{{ route('blog.active') }}">
                                    <button class="nav-link active" id="nav-home-tab" type="button" aria-selected="true">Đã
                                        được Duyệt</button>
                                </a>
                                <a href="{{ route('blog.inactive') }}">
                                    <button class="nav-link " id="nav-profile-tab" type="button" aria-selected="false">Đang
                                        chờ duyệt</button>
                                </a>
                            </div>
                        </nav>
                                        ...
                                        <tbody>
                                            @foreach ($blogs as $blog)
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="{{ route('blog.show', [$blog->id]) }}"><i
                                                                class="fa-solid fa-eye"></i></a>
                                                        <a href="{{ route('blog.show-check-approved', [$blog->id]) }}"><i
                                                        ...
                                                        <div class="modal fade" id="deleteBlogModal-{{ $blog->id }}"
